...
class PushTask():
    ...
    def get_eval_trajectories(
        ...
        if kloss_dataset:
            ...
            return _load_trajectories("/home/xucheng/xh/data/MuJoCo_Push/gentle_push_10.hdf5", **dataset_args)
            ...
            if modalities == None or 'image' in modalities:
                ...
                for i in range(10):
                    trajectories['image'].append(_load_trajectories(
                        "/home/xucheng/xh/data/MuJoCo_Push/gentle_push_300.hdf5", visual_noise=i/10, **dataset_args))
            if modalities == None or 'gripper_pos' in modalities:
                trajectories['proprio'] = []
                for i in range(10):
                    trajectories['proprio'].append(_load_trajectories(
                        "/home/xucheng/xh/data/MuJoCo_Push/gentle_push_300.hdf5", prop_noise=i/10, **dataset_args))
            if modalities == None or 'gripper_sensors' in modalities:
                trajectories['haptics'] = []
                for i in range(10):
                    trajectories['haptics'].append(_load_trajectories(
                        "/home/xucheng/xh/data/MuJoCo_Push/gentle_push_300.hdf5", haptics_noise=i/10, **dataset_args))
            if modalities == None or 'controls' in modalities:
                trajectories['controls'] = []
                for i in range(10):
                    trajectories['controls'].append(_load_trajectories(
                        "/home/xucheng/xh/data/MuJoCo_Push/gentle_push_300.hdf5", controls_noise=i/10, **dataset_args))
            if modalities == None:
                trajectories['multimodal'] = []
                for i in range(10):
                    trajectories['multimodal'].append(_load_trajectories(
                        "/home/xucheng/xh/data/MuJoCo_Push/gentle_push_300.hdf5", multimodal_noise=i/10, **dataset_args))
            return trajectories
